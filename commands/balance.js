...
export const description = 'Command for getting your current state statistics! Do NOT use in public channels.';
...
/**
 * Function acquires nation's data and print embeds it into the message channel.
 * @param {Message} message     Message to retrieve channel to interact with.
 * @param {Array} args          Arguments array of [User]. User's balance is printed.
 */
export function execute(message, args) {
    ...
    gm.findVertical('Data', 'A', message)
        .then(pricesRow => {
            //row - 1 will exclude priceRow
            fn.ss(['getA', 'A5', `AZ${pricesRow - 1}`], message)
                .then(array => {
